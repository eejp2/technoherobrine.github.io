var farm = {
    ...
    lollipopsProduction : 9999, // How many lollipops the farm produce every day, hour, min, sec.. depending on the production delay type
    ...
    calculateLollipopsPerDay : function(){
        if(this.lollipopsPlanted <= 293){ // sqrt(86400) = 293
            ...
            var prod = this.lollipopsPlanted * 999; // 194 will give 86000
